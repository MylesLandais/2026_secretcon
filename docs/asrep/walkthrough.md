...
Artifacts land under `artifacts/asrep/observability-loop/` and `artifacts/asrep/stress-campaign/`. See [blue-detection-faq.md](blue-detection-faq.md) for rule fire-rate interpretation.
...
See [proxmox-deploy-recon.md](proxmox-deploy-recon.md) for range inventory notes.
