...
| 05 | Phase 5 | `read_user_flag.sh` | 1s | 12 | 26 | — | `60106` (3) | 1 | First tour used Joe WinRM (401). Fixed helper reads flag as Administrator. |
...
| 08 | Phase 8 | `read_root_flag.sh` | 2s | 16 | 22 | — | `60106` (3) | 0 | Post-privesc admin read; no flag token in SIEM (file content not logged). |
