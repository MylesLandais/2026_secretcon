# Shared Proxmox + SSH settings for SecretCon Windows/ Ubuntu Packer recipes in this directory.
# Loaded automatically with any sibling *.pkr.hcl when you run packer init/build here.
